...
<div class="card shadow">
    <div class="row card-header p-2 m-0">
        ...
        <div class="col-lg-6 col-xl-6 col-md-6 col-xs-6 col-sm-6 col-6" align="right">
            <a href="../" class="btn btn-dark btn-sm btn-icon-split mt-2">
                <span class="icon text-white-50"><i class="fas fa-backward"></i></span>
                <span class="text p-1">Kembali</span>
            </a>

            <a href="../laporan_transaksi" class="btn btn-primary btn-sm btn-icon-split mt-2">
                <span class="icon text-white-50"><i class="fas fa-list"></i></span>
                <span class="text p-1">Detail</span>
            </a>
        </div>
    </div>
